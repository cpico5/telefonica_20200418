...
/////////////////////  TABLA ENCUESTAS  ///////////////////////////////////////////////
    ...
    private static final String DATABASE_ENCUESTA= "create table "
            ...
            + TablaEncuestas.COLUMNA_preguntavive +  " text, "
            ...
            + TablaEncuestas.COLUMNA_pregunta_c8a1 +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c8a2 +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c8a3 +  " text, "
